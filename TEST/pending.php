...
$query = "SELECT complain.id, complain.Scode, dateofcomplain, customer.customername,complain.username,
complain.Mnumber,complain.query,complain.ReferredTo, complain.Solution,users.full_name
FROM `complain` INNER JOIN customer ON complain.Mnumber=customer.Mnumber INNER JOIN users ON complain.ReferredTo = users.username
WHERE complain.username='$ss' AND complain.Scode ='PENDING' ORDER BY complain.id DESC"; 
...
<ul>
  ...
  <li><a class="notification" href="" style="font-weight: bold; float:right;position: absolute;left: 900px; top: 208px;">
  ...
  <li> <a href="notify.php" class ="notification" style="font-weight: bold; position:absolute;left:100px;top: 208px;">
  <span>INBOX</span>
				...
				while($fetchRow = mysqli_fetch_array($result)){?>	
					...
					<div id="inner" style="color:red;text-align:center;">	
						<?php 
								...
								{?>
									<h2>You do not have any pending complains!!!</h3>
